        ...
        <footer className="pt-16 md:pt-24 pb-6 text-center">
                <div className="grid grid-cols-2 md:grid-cols-3">
                    <div>
                        ...
                        <p className="mt-4 text-lg text-zinc-500 font-bold">Høje Taastrup Boulvard 24, <br/>2630, Høje Tåstrup, Denmark</p>
                        <hr className="max-w-[220px] mx-auto my-2"/>
                    
                        <p className="text-lg text-zinc-500 font-bold">+45 43 52 72 71</p>
                        <p className="text-zinc-500 text-lg underline font-bold">info@cafekebabhouse.dk</p>
                    </div>

                    <div className="text-lg md:text-2xl lg:text-3xl font-semibold text-zinc-400">
                        ...
                        <div className="text-lg text-zinc-500 mt-2 font-bold">
                        ...
                        <button className="flex mx-auto gap-2 items-center text-lg text-center mt-4 md:mt-8 px-3 py-2 tracking-wider bg-green-600/60 rounded-lg hover:text-green-700 hover:bg-transparent transition group">
                ...
                <span className="block text-sm text-center text-gray-500 mt-4 md:mt-10">
